...
state=Indonesia
locality=Indonesia
organization=CobekSawit
organizationalunit=CobekSawit
commonname=CobekSawit
email=admin@cobeksawit.xyz
...
wget -q -O /usr/local/bin/ws-dropbear "https://raw.githubusercontent.com/csvpndev/kucing/main/tools/ws-dropbear"
...
wget -q -O /usr/local/bin/ws-stunnel "https://raw.githubusercontent.com/csvpndev/kucing/main/tools/ws-stunnel"
...
wget -q -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/csvpndev/kucing/main/tools/newudpgw"
...
# Install Stunnel5
cd /root/
wget -q "https://raw.githubusercontent.com/csvpndev/kucing/main/tools/stunnel5.zip"
unzip stunnel5.zip
cd /root/stunnel
chmod +x configure
./configure
...
wget -q -O /etc/init.d/stunnel5 "https://raw.githubusercontent.com/csvpndev/kucing/main/tools/stunnel5.init"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/csvpndev/kucing/main/issue.net"
...
cd
wget -O /usr/bin/badvpn-udpgw https://raw.github.com/Rerechan02/sl/main/badvpn/badvpn-udpgw && chmod +x  /usr/bin/badvpn-udpgw
#system badvpn 7300
wget -O /etc/systemd/system/svr-7300.service https://raw.github.com/Rerechan02/sl/main/badvpn/svr-7300.service && chmod +x  /etc/systemd/system/svr-7300.service
#system badvpn 7200
wget -O /etc/systemd/system/svr-7200.service https://raw.github.com/Rerechan02/sl/main/badvpn/svr-7200.service && chmod +x  /etc/systemd/system/svr-7200.service
#system badvpn 7100
wget -O /etc/systemd/system/svr-7100.service https://raw.github.com/Rerechan02/sl/main/badvpn/svr-7100.service && chmod +x  /etc/systemd/system/svr-7100.service

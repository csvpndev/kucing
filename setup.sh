...
export KEY="5812023529:AAEQ722zvUwMByHXQMW8QeP_qSCs1kHfp_g"
export TIME="10"
...
# https://raw.githubusercontent.com/csvpndev/taikucing/main/mek 
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/csvpndev/taikucing/main/mek | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/csvpndev/taikucing/main/mek | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
echo -e "${tyblue} Welcome To csvpndev/taikucing/main/mek Sawit Tunnel${NC} "
sleep 2
...
echo -e "└─────────────────────────────────────────┘"
sleep 1 
wget -q https://raw.githubusercontent.com/csvpndev/kucing/main/tools/arzsource.sh && chmod +x arzsource.sh && ./arzsource.sh
#install ssh-vpn
echo -e "┌─────────────────────────────────────────┐"
...
echo -e "└─────────────────────────────────────────┘"
sleep 1 
wget -q https://raw.githubusercontent.com/csvpndev/kucing/main/tools/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
...
echo -e "└─────────────────────────────────────────┘"
sleep 1 
wget -q https://raw.githubusercontent.com/csvpndev/kucing/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh

# // Download Data
echo -e "${GREEN}Download Data${NC}"
wget -q -O /usr/bin/usernew "https://raw.githubusercontent.com/csvpndev/kucing/main/usernew.sh"
...
wget -q -O /usr/bin/add-vless "https://raw.githubusercontent.com/csvpndev/kucing/main/add-vless.sh"
wget -q -O /usr/bin/add-tr "https://raw.githubusercontent.com/csvpndev/kucing/main/add-tr.sh"
wget -q -O /usr/bin/autoreboot "https://raw.githubusercontent.com/csvpndev/kucing/main/options/autoreboot.sh"
wget -q -O /usr/bin/restart "https://raw.githubusercontent.com/csvpndev/kucing/main/options/restart.sh"
wget -q -O /usr/bin/tendang "https://raw.githubusercontent.com/csvpndev/kucing/main/options/tendang.sh"
wget -q -O /usr/bin/clearlog "https://raw.githubusercontent.com/csvpndev/kucing/main/options/clearlog.sh"
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/csvpndev/kucing/main/options/running.sh"
#wget -q -O /usr/bin/cek-trafik "https://raw.githubusercontent.com/csvpndev/kucing/main/options/cek-trafik.sh"
wget -q -O /usr/bin/speedtest "https://raw.githubusercontent.com/csvpndev/kucing/main/tools/speedtest_cli.py"
wget -q -O /usr/bin/cek-bandwidth "https://raw.githubusercontent.com/csvpndev/kucing/main/options/cek-bandwidth.sh"
wget -q -O /usr/bin/limitspeed "https://raw.githubusercontent.com/csvpndev/kucing/main/options/limitspeed.sh"
wget -q -O /usr/bin/menu-vless "https://raw.githubusercontent.com/csvpndev/kucing/main/menu/menu-vless.sh"
wget -q -O /usr/bin/menu-vmess "https://raw.githubusercontent.com/csvpndev/kucing/main/menu/menu-vmess.sh"
...
wget -q -O /usr/bin/addhost "https://raw.githubusercontent.com/csvpndev/kucing/main/menu/addhost.sh"
wget -q -O /usr/bin/certxray "https://raw.githubusercontent.com/csvpndev/kucing/main/menu/crt.sh"
wget -q -O /usr/bin/menu-set "https://raw.githubusercontent.com/csvpndev/kucing/main/menu/menu-set.sh"
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/csvpndev/kucing/main/version  )
...
Client Name: $Name
==================================
[ORDER](buttonurl:https://t.me/cobeksawitofficial)
"
clear
